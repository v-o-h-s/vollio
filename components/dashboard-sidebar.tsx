                        ...
                        {isCollapsed ? (
                            ...
                            <>
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h1 className="font-bold text-xl text-gray-900 tracking-tight">Noto</h1>
                                        <p className="text-xs text-gray-500 font-medium">Productivity Suite</p>
                                    </div>
                                </div>
                                <button
                                    onClick={toggleCollapse}
                                    ...
                                    >
                                        {
                                            user.user && user && user.user.imageUrl ?
                                                ...
                                                <Image src={user.user?.imageUrl} width={40} height={40} alt="image" className="rounded-2xl" />
                        ...
                        {!isCollapsed && (
                            <>
                                ...
                                <div className="flex-1 min-w-0">
                                    <div className="font-semibold text-sm text-gray-900 truncate">{user.user?.fullName}</div>
                                    <div className="text-xs text-gray-500 truncate">{user.user?.emailAddresses[0].emailAddress}</div>
                                </div>
