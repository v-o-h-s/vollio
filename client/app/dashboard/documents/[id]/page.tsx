...
import { Noter } from "@/features/document-view/components/notes";

const BetterViewer = dynamic(
  () =>
    import("@/features/document-view/components/BetterViewer").then(
...
const AssistantChat = dynamic(
  () =>
    import("@/features/document-view/components/Assistant/AssistantChat").then(
...
import {
  ViewerProvider,
  useViewer,
} from "@/features/document-view/context/ViewerContext";
