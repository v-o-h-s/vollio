...
export const EnhancedNoteCard = memo<EnhancedNoteCardProps>(
  ({
    ...
    const cardClasses = useMemo(() => {
      const baseClasses =
        "enhanced-note-card group cursor-pointer transition-all duration-300 hover-lift relative overflow-hidden rounded-xl";
        ...
        <Card className={cardClasses} onClick={handleCardClick}>
          ...
          <div className="flex items-start gap-4 relative z-10">
            ...
            <div className="flex-1 min-w-0 space-y-2">
              ...
              {/* Preview text */}
              {showPreview && (
                <div className={previewClasses}>{previewText}</div>
              )}
        ...
        <div className="relative z-10">
          ...
          <div className="flex items-start justify-between mb-3">
            <div className="flex-1 min-w-0">
              <h3 className={titleClasses}>{note.title || "Untitled Note"}</h3>
            </div>
          ...
          {showPreview && variant !== "compact" && (
            <div className={`${previewClasses} mb-4`}>{previewText}</div>
          )}
