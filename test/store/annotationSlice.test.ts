...
type TestRootState = {
  annotations: ReturnType<typeof annotationSlice>
}
...
describe('annotationSlice', () => {
  ...
  describe('initial state', () => {
    it('should have correct initial state', () => {
      const state = (store.getState() as TestRootState).annotations
  ...
  describe('loadAnnotations', () => {
    it('should load annotations array into normalized state', () => {
      ...
      expect(Object.keys((store.getState() as TestRootState).annotations.annotations)).toHaveLength(1)
  ...
  describe('setActiveSelection', () => {
    ...
    it('should clear active selection', () => {
      store.dispatch(setActiveSelection(mockTextSelection))
      expect((store.getState() as TestRootState).annotations.activeSelection).toEqual(mockTextSelection)
  ...
  describe('annotation hover management', () => {
    ...
    it('should clear hovered annotation', () => {
      const store = createTestStore();
      store.dispatch(setHoveredAnnotation('annotation-1'));
      expect((store.getState() as TestRootState).annotations.hoveredAnnotation).toBe('annotation-1');
  ...
  describe('preview card state management', () => {
    ...
    it('should hide preview card', () => {
      ...
      expect((store.getState() as TestRootState).annotations.previewCard.visible).toBe(true);
